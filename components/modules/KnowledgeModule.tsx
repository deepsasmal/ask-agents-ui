...
export const KnowledgeModule: React.FC = () => {
    return (
        <div className="flex-1 h-full flex items-center justify-center bg-slate-50 dark:bg-slate-900 p-6 flex-col">
            <div className="w-24 h-24 bg-blue-50 rounded-full flex items-center justify-center mb-6 shadow-sm dark:bg-blue-900/20">
                <BookOpen className="w-12 h-12 text-blue-600 dark:text-blue-400" />
            </div>

            <h2 className="text-3xl font-bold text-slate-900 mb-3 dark:text-white">Knowledge Base</h2>
